...
w&&setTimeout(function(){X(C)},0)}w=function(){I.apply(this,arguments)};i=function(){I.apply(this,arguments)};U&&(i.node=K,U.plugin("scrollable",i));if(t){t.extend(t.fn,{scrollable:function(){this.forEach(function(b){I(b)});return this},scrollableNode:function(){var b=$();this.forEach(function(a){(a=K(a))&&b.push(a)});return b}});var H=t.fn.scrollTop,T=t.fn.scrollLeft;t.fn.scrollTop=function(b){if(typeof b==="undefined"){var a=this[0],c=r(a);return c&&a._scrollTop?a._scrollTop():H?H.apply(this,arguments):
c?a.scrollTop:null}this.forEach(function(a){var c=r(a);if(c&&a._scrollTop)a._scrollTop(b);else if(H)H.call(t(a),b);else if(c)a.scrollTop=b});return this};t.fn.scrollLeft=function(b){if(typeof b==="undefined"){var a=this[0],c=r(a);return c&&a._scrollLeft?a._scrollLeft():H?T.apply(this,arguments):c?a.scrollLeft:null}this.forEach(function(a){var c=r(a);if(c&&a._scrollLeft)a._scrollLeft(b);else if(T)T.call(t(a),b);else if(c)a.scrollLeft=b});return this}}if(u){u.fn.scrollable=function(){this.each(function(){I(this)});
return this};u.fn.scrollableNode=function(){var b=$();this.each(function(){var a=K(this);a&&(b=b.add(a))});return b};var da=u.fn.scrollTop,ea=u.fn.scrollLeft;u.fn.scrollTop=function(b){if(typeof b==="undefined"){var a=this[0];return r(a)&&a._scrollTop?a._scrollTop():da.apply(this,arguments)}this.each(function(){r(this)&&this._scrollTop?this._scrollTop(b):da.call(u(this),b)});return this};u.fn.scrollLeft=function(b){if(typeof b==="undefined"){var a=this[0];return r(a)&&a._scrollLeft?a._scrollLeft():
ea.apply(this,arguments)}this.each(function(){r(this)&&this._scrollLeft?this._scrollLeft(b):ea.call(u(this),b)});return this}}w.node=K;return w}(window,document,window.clik,window.Zepto,window.jQuery);
